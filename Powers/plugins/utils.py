...
async def reporting_query(c: Gojo, m: Message):
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton("Update channel",url=f"https://t.me/{SUPPORT_GROUP}")],[InlineKeyboardButton("Report me on telegram",url="https://t.me/whitehell097")]])
    try:
...
**Example:**
`/git whitehell097`: this fetches the information about a user from the database."""
